...
model = Sequential()
model.add(Convolution2D(100, (5, 5), padding="valid", input_shape=(1,32,32),data_format='channels_first'))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Activation('tanh'))
model.add(Convolution2D(250, (5, 5), padding="valid"))
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Activation('tanh'))
model.add(Flatten())
...
model.fit(train_dataset, train_labels, batch_size=batch_size, epochs=nb_epoch,
